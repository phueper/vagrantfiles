...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define :ubuntu_wls12 do |ubuntu_wls12|
    ...
    # this is a 12.04 LTS VirtualBox image
    ubuntu_wls12.vm.box_url = "http://cloud-images.ubuntu.com/vagrant/precise/current/precise-server-cloudimg-amd64-vagrant-disk1.box"

    ubuntu_wls12.vm.hostname = "ubuntu-wls12.local"
    ...
    ubuntu_wls12.vm.network "private_network", type: :dhcp #, ip: "192.168.57.100"

    # install chef using omnibus installer using shell
    ubuntu_wls12.vm.provision :shell, :inline => "which chef-solo || curl -L https://www.opscode.com/chef/install.sh | bash"
